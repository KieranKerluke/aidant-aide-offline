  ...
  useEffect(() => {
    ...
    if (code) {
      ...
      handleAuthCallback(code)
        .then(async () => {
          try {
            // Initialize the Google Drive database after successful authentication
            await initDatabase();
            navigate('/');
          } catch (error) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="text-center max-w-md p-6 bg-white rounded-lg shadow-md">
        ...
        <p className="mb-6">Please sign in with your Google account to access your data stored in Google Drive</p>
