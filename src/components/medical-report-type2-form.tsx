...
import { MedicalReportType2, createMedicalReport, updateMedicalReport } from "@/lib/db";
...
interface MedicalReportType2FormProps {
  sessionId: number;
  report: MedicalReportType2 | null;
  onSaved: (report: MedicalReportType2) => void;
  onCancel: () => void;
}
...
export function MedicalReportType2Form({ sessionId, report, onSaved, onCancel }: MedicalReportType2FormProps) {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      onSaved(savedReport as MedicalReportType2);
    } catch (error) {
      console.error("Error saving medical report type 2:", error);
    } finally {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardContent className="space-y-6 pt-6">
            <h2 className="text-xl font-semibold mb-4">
              {report ? "Edit Medical Report Type 2" : "Create Medical Report Type 2"}
            </h2>
