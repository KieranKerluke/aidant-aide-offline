...
import { FamilyReportType1, createFamilyReport, updateFamilyReport } from "@/lib/db";
...
interface FamilyReportType1FormProps {
  sessionId: number;
  report: FamilyReportType1 | null;
  onSaved: (report: FamilyReportType1) => void;
  onCancel: () => void;
}
...
export function FamilyReportType1Form({ sessionId, report, onSaved, onCancel }: FamilyReportType1FormProps) {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      onSaved(savedReport as FamilyReportType1);
    } catch (error) {
      console.error("Error saving family report type 1:", error);
    } finally {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardContent className="space-y-6 pt-6">
            <h2 className="text-xl font-semibold mb-4">
              {report ? "Edit Family Report Type 1" : "Create Family Report Type 1"}
            </h2>
